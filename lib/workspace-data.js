...
const gatherSkills = () => {
  ...
  const fallback = [
    { name: 'kid-insights', rating: '4.9', desc: 'Monitor Kid core signals', downloads: '6.4K', updated: '1d ago', icon: '💡' },
    { name: 'vibe-ml', rating: '4.6', desc: 'Generative timeline prompts', downloads: '3.2K', updated: '3d ago', icon: '✨' }
  ];
